...
const PAGE_CATEGORIES = [
  ...
  { id: "classic_sheets", name: "Classic Sheets" },
  { id: "storybook", name: "Storybook" },
  { id: "animal_friends", name: "Animal Friends" },
...
function createPages() {
  const pages = [
    ...
    { id: "garden", name: "Garden", category: "starter", draw: drawGardenPage },
    { id: "rocket", name: "Rocket", category: "starter", draw: drawRocketPage },
    { id: "ocean", name: "Ocean", category: "starter", draw: drawOceanPage },
    { id: "dino", name: "Dino", category: "starter", draw: drawDinoPage }
  ];

  for (const sheet of PUBLIC_DOMAIN_SHEETS) {
    pages.push({
      id: sheet.id,
      name: sheet.name,
      category: "classic_sheets",
      source: sheet.source,
